...
public class Launcher extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //LauncherAppState   该对象  对桌面的默认配置数据进行了初始化和计算， 比如桌面图标和文字大小.....
// LauncherAppState 是 model ， model 负责数据加载，然后回调到 laucher Activity 回调显示数据 ,这里就是  controller
        //  controller 通知 view
        //  采用mvc 的模式这里

        // ??  如何 回调
        /**      mModel = app.setLauncher(this);  设置控制 laucher 到 model 中
         *       laucher 实现回调 接口
         *       LauncherModel.Callbacks  用于和 LaucherModel 交互
         *       LauncherProviderChangeListener    用于和 LaucherProvider 交换
         */
